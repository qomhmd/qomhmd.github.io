...
motto: >
  <p class="motto text-center">
    <a href="https://www.womanlifefreedom.today/" target="_blank">"Woman, Life, Freedom"</a>
  </p>
  <hr width="20%">
  <p class="text-center">
    <a href="http://ps752justice.com/">
      <img style="width: 100px;" src="/assets/img/The_Association_of_Families_of_Flight_PS752_Victims_logo.svg.png" alt="The Association of Families of Flight PS752 Victims logo" title="#PS752">
    </a>
  </p>
profile:
  align: right
...
Software programming has become my currently other vocation since teenage years. Generally, I love everything that can do something not for the sake of itself but as a means to the end of a serence life. I'm almost always eager for contributing to a better world 😃
